...
class Signals:
    ...
    def human_speaking(self, value):
        ...
        if value:
            logger.debug("SIGNALS: Human Talking Start")
        else:
            logger.debug("SIGNALS: Human Talking Stop")
    ...
    def AI_speaking(self, value):
        ...
        if value:
            logger.debug("SIGNALS: AI Talking Start")
        else:
            logger.debug("SIGNALS: AI Talking Stop")
    ...
    def AI_thinking(self, value):
        ...
        if value:
            logger.debug("SIGNALS: AI Thinking Start")
        else:
            logger.debug("SIGNALS: AI Thinking Stop")
    ...
    def new_message(self, value):
        ...
        if value:
            logger.debug("SIGNALS: New Message")
